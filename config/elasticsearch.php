        ...
        'default' => [
            ...
            'hosts' => [
                [
                    ...
                    /** aws_credentials in also add $memorizedprovider */
                    /** aws_credential in also add  [\Aws\Credentials\CredentialProvider::class, 'defaultProvider']*/
                    /** aws_credential in also add $credentials*/
